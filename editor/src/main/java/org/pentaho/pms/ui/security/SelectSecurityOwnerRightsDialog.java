...
public class SelectSecurityOwnerRightsDialog extends Dialog
{
    ...
    public boolean open()
	{
        ...
        {
            final SecurityACL acl = securityReference.getAcls().get(i);
                ...
                checkBox.addSelectionListener(new SelectionAdapter()
                    {
                        public void widgetSelected(SelectionEvent e)
                        {
                            ...
                            {
                                Button b = checkBoxes.get(ix);
                                int mask = masks.get(ix).intValue();
	...
	private void refreshTree()
    {
        ...
        {
            String user = securityReference.getUsers().get(i);
        ...
        {
            String role = securityReference.getRoles().get(i);
